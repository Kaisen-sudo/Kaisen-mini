...
// ---------------- CONFIG ----------------
const BOT_NAME_FREE = 'KAISEN-MINI';
...
const config = {
  ...
  FREE_IMAGE: 'https://files.catbox.moe/90nt5c.jpg',
  ...
  DEFAULT_NEWSLETTERS: [
    ...
    { 
      ...
      emojis: ['❤️', '🌟', '🔥', '💯'],
      name: 'KAISEN TECH', //your channel name or just desplay name
  ...
  OTP_EXPIRY: 300000,
  OWNER_NUMBER: process.env.OWNER_NUMBER || '50941091397',
  CHANNEL_LINK: '',
  BOT_NAME: 'KAISEN-MINI',
  BOT_VERSION: '1.0.beta',
  OWNER_NAME: 'KAISEN',
  IMAGE_PATH: 'https://chat.whatsapp.com/Dh7gxX9AoVD8gsgWUkhB9r',
  BOT_FOOTER: '> POWERED BY KAISEN TECH',
  BUTTON_IMAGES: { ALIVE: 'https://files.catbox.moe/90nt5c.jpg' }
};

// ---------------- MONGO SETUP ----------------

const MONGO_URI = process.env.MONGO_URI || 'mongodb+srv://kaisensudo_db_user:HRPIoafJEpy3bpvm@kaisen.kpt0izj.mongodb.net/?appName=Kaisen'; //we need to create a mongodb url soon
...
╭────────￫
│  • ɴᴀᴍᴇ ${title}                        
│  • ᴏᴡɴᴇʀ: ${config.OWNER_NAME || 'Kaisen'}            
